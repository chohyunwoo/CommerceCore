...
33. 관리자 대시보드 개편 2단계 — 통계 대시보드(백엔드 집계 API + Recharts 5개 지표, 결정 42)
34. 관리자 대시보드 개편 3단계 — 회원·구매자 관리(읽기 전용 목록/검색, 결정 42)
35. 다음 기능 검토 중 — Double-entry Ledger, 멀티 PG Orchestration (PortOne 추가)
